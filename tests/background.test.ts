...
describe('BackgroundService', () => {
  ...
  beforeEach(() => {
    ...
    (mockChrome.runtime.onMessage.addListener as jest.Mock).mockImplementation(
      (listener: any) => {
    ...
    describe('fetchCVEData action', () => {
      it('should fetch CVE data for valid CVE ID', async () => {
        ...
        const result = messageListener(
          { action: 'fetchCVEData', cveId: 'CVE-2023-1234' },
          {},
          sendResponse
        );
      ...
      it('should return cached data for repeated CVE requests', async () => {
        ...
        // First request
        messageListener(
          { action: 'fetchCVEData', cveId: 'CVE-2023-5678' },
          {},
          sendResponse1
        );
      ...
      it('should handle API errors gracefully', async () => {
        ...
        const sendResponse = jest.fn();
        const promise = messageListener(
          { action: 'fetchCVEData', cveId: 'CVE-2023-9999' },
          {},
          sendResponse
        );
      ...
      it('should handle non-OK responses', async () => {
        ...
        const sendResponse = jest.fn();
        messageListener(
          { action: 'fetchCVEData', cveId: 'CVE-2023-0000' },
          {},
          sendResponse
        );
  ...
  describe('Retry Logic', () => {
    it('should retry on server error (5xx)', async () => {
      ...
      const sendResponse = jest.fn();
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-RETRY' },
        {},
        sendResponse
      );
    ...
    it('should not retry on client error (4xx)', async () => {
      ...
      const sendResponse = jest.fn();
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-404' },
        {},
        sendResponse
      );
    ...
    it('should retry on network errors', async () => {
      ...
      const sendResponse = jest.fn();
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-NET' },
        {},
        sendResponse
      );
  ...
  describe('Cache Management', () => {
    it('should expire cache after TTL', async () => {
      ...
      // First request
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-TTL' },
        {},
        sendResponse1
      );
  ...
  describe('Data Processing', () => {
    it('should process Vulners API data correctly', async () => {
      ...
      const sendResponse = jest.fn();
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-PROC' },
        {},
        sendResponse
      );
    ...
    it('should handle partial data gracefully', async () => {
      ...
      const sendResponse = jest.fn();
      messageListener(
        { action: 'fetchCVEData', cveId: 'CVE-2023-PARTIAL' },
        {},
        sendResponse
      );
